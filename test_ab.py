...
def test_broken_images(page):
    page_header_assertion(page, "text=Broken Images", "Broken Images", True)

def page_header_assertion(page, locator_text, expected_header_text, screenshot=False):
    ...
    if screenshot:
        take_screenshot(page, expected_header_text)